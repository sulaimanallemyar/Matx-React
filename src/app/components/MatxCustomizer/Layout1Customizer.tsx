...
import { themeColors, ThemeColorsInterface, themeShadows } from '../MatxTheme/themeColors';
...
const ToolbarContent = styled('div')(({ color }: { color: ThemeColorsInterface }) => ({
  width: 40,
  height: 40,
  margin: '8px',
  cursor: 'pointer',
  ...
  return (
    <Fragment>
      <Box mb="16px" mx="12px">
        ...
        <ToolbarContainer>
          {mainSidebarThemes.map((color: any, i) => (
