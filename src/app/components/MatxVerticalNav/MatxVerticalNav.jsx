...
import { checkAuthorities } from 'app/auth/private-routes';
...
const MatxVerticalNav = () => {
  ...
  const navigations = [
    { name: 'Dashboard', path: '/dashboard/default', icon: 'dashboard', isHidden: true },
    { label: 'Settings', type: 'label' },
    {
      name: 'Settings',
      icon: 'setting',
      children: [
        { name: 'Users', iconText: 'SI', path: '/users/list' },
        {
          name: 'Roles',
          iconText: 'SU',
          path: '/roles/list',
